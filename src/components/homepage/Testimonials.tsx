...
const testimonials = [
  {
    ...
    quote: "Monks transformed our digital strategy completely. The results exceeded our expectations in every metric.",
    avatar: "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
  },
  {
    name: "Robert Lee",
    role: "Founder, eCommerce",
    quote: "Working with Monks was a game changer. Their strategic approach and execution excellence is unmatched.",
    avatar: "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
  },
  {
    name: "Maya Singh",
    role: "Product Lead, Fintech",
    quote: "The team at Monks brings incredible depth of expertise. They delivered beyond what we thought was possible.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-monks-gray max-w-2xl mx-auto">
            See what our clients say about working with Monks
          </p>
        </div>
